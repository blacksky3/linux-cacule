...
Linux kernel build for Archlinux with Hamad Al Marri CacULE CPU scheduler (kept alive artificially by Piotr Górski), Arch, Block, CPU, CPU Power, Futex and kernel_compiler_patch patch.
