...
Linux kernel build for Archlinux with Hamad Al Marri CacULE CPU scheduler (kept alive artificially by Piotr Górski), AMD, Arch, Block, CPU, BTRFS, Futex, Wine and kernel_compiler_patch patch.
