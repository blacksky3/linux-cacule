...
Linux kernel build for Archlinux with Hamad Al Marri CacULE CPU scheduler, Piotr Górski Arch and Block patches, XanMod CPU Power patch and Graysky2 kernel_compiler_patch patch.
